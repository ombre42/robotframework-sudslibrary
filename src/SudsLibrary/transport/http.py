...
class HttpTransport(Transport):
    ...
    def u2handlers(self):
        ...
        #return [urllib2.ProxyHandler({'http': 'localhost:8888'})]
    ...
    def __get_request_url_for_urllib(request):
        ...
        """
        # this is not needed because this code is only for execution on
        # Jython < 2.6. Removal needed for compatibility with suds as suds-jurko
        # automatically converts to Unicode on relevant platforms.
